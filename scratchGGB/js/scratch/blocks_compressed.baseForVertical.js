...
function randomColour () {return "#" + ("00000" + Math.floor(Math.random() * Math.pow(2, 24)).toString(16)).substr(-6)}

Blockly.Blocks.colour_picker = {
  init: function () {
    this.jsonInit({
      message0: "%1",
      args0: [{type: "field_colour_slider", name: "COLOUR", colour: randomColour()}],
...
Blockly.Colours = {
  ...
  operators: {
    primary: "#59C059",
    secondary: "#46B946", tertiary: "#389438"
  },
...
Blockly.Colours.overrideColours = function (c) {
  if (c) {
    for (var a in c) if (c.hasOwnProperty(a) && Blockly.Colours.hasOwnProperty(a)) {
      var b = c[a];
      if (goog.isObject(b)) for (var d in b) b.hasOwnProperty(d) && Blockly.Colours[a].hasOwnProperty(d) && (Blockly.Colours[a][d] = b[d]); else Blockly.Colours[a] = b
    }
  }
};
Blockly.Blocks.math = {};
